...
#include "stdafx.h"
#include "spitonicstepsequencersynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicstepsequencersynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicstepsequencersynthvoroguiwin32class"};				// the main window class name
